...
if (!class_exists('ButterBean')) {
    ...
    final class ButterBean
    {
        ...
        {
            $this->dir_path = apply_filters('butterbean_dir_path', trailingslashit(WB_DIR.'butterbean'));
            $this->dir_uri = apply_filters('butterbean_dir_uri',  trailingslashit(WB_URI.'butterbean'));
